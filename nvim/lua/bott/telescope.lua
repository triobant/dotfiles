...
M.git_branches = function()
        require("telescope.builtin").git_branches({
                attach_mappings = function(_, map)
                        map("i", "<c-d>", actions.git_deleted_branches)
                        map("n", "<c-d>", actions.git_deleted_branches)
                        return true
                end,
        })
end
...
M.dev = function(opts)
        ...
        if not ok then
                print("===================================================")
                print("HEY, BOTT. YOUR CODE DOESNT WORK. THIS IS NOT ON ME")
                print("===================================================")
                return
        end
        ...
        if #mod_name ~= 2 then
                print("===================================================")
                print("HEY BOTT. I DO NOT KNOW HOW TO FIND THIS FILE:")
                print(dev)
                print("===================================================")
        end
